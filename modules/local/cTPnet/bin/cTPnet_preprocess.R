preprocess_seurat2=function(seurat_data,dprotein,rna_names=''){
    if (rna_names[1] != ''){
      shared_gene =rna_names
    }else if (dprotein==12){
    	data(gene_names_protein12)
    }else if (dprotein==24){
    	data(gene_names_protein24)
    }else if (dprotein=='custom'){
      data(gene_names_protein24)
    }else{
...
preprocess_seurat3=function(seurat_data,dprotein,rna_names=''){
    if (rna_names[1] != ''){
      shared_gene =rna_names
    }else if (dprotein==12){
...
preprocess_matrix=function(matrix_data,dprotein,rna_names=''){
    if (rna_names[1] != ''){
      shared_gene =rna_names
    }else if (dprotein==12){
    	data(gene_names_protein12)
