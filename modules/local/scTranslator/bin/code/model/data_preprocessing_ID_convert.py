...
def main():
    ...
    parser.add_argument('--origin_gene_column', type=str, default='index',
                        help='Colum name of origin gdene location, eg. index, feature, gene, protein')
    ...
    dic_path = os.path.join( args.moduledir[0] + '/bin/code/model/ID_dic/')
    ...
    destfile = os.path.join(file_name  + '_mapped.h5ad')
    filtered_adata.write(destfile)
